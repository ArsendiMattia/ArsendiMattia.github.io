...
where $\sigma$ corresponts to a sigmoid function. Function \eqref{eq:cinque} can be written as a ***graph*** where the intermediate variables are explicitly specified, as shown in Figure 1.
