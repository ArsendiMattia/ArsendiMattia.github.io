...
f(x_1, x_2) = \sigma\left[ \right. \nonumber \\
  & v_1 \cdot \sigma(w_{1,1} \cdot x_1 + w_{1,2} \cdot x_2 + b_1) \, + \nonumber \\
  & v_2 \cdot \sigma(w_{2,1} \cdot x_1 + w_{2,2} \cdot x_2 + b_2) \, + \nonumber \\
  & v_3 \cdot \sigma(w_{3,1} \cdot x_1 + w_{3,2} \cdot x_2 + b_3) \nonumber \\
\left. \right]
\label{eq:cinque} \, ,
\end{align}
$$

where $\sigma$ corresponts to a sigmoid function. 
