...
$$
\begin{align}
  \log p( \boldsymbol{\theta} \mid \boldsymbol{y}, \boldsymbol{x}) \label{eq:uno}
...
By combining both Equation \eqref{eq:uno} and Equation \eqref{eq:due}, the log posterior distribution \eqref{eq:due} can be written as 
