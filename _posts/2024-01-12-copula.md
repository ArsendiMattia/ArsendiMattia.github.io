...
|:--------------:|:--------------:|:--------------:|:--------------:|
| arsenal        | forest         | 15             | 1              |
| arsenal        | crystal        | 13             | 0              |
| ...            | ...            | ...            | ...            |
| berlin         | leverkusen     | 2              | 0              |
| berlin         | augsburg       | 14             | 1              |.

As we can see, we have a collection of historical matches of football teams (ENG, ITA, FRA, ESP, GER) of the 2023/2024 season. Specifically, the following are the features gathered:

*Team*
: The team to which the focus is funneled, 

*Opponent*
: The team faced by the considered *Team*, 
