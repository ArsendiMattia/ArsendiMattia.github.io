---
title: Bayesian Copula Modelling football teams' number of shots
date: 2024-09-14
comments: true
toc: true
math: true
...
The main motivation for using a Copula model is that if we want to model the number of shots of each team
