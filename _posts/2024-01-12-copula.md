...
Before diving into the Model Development step, let's explore the data to see if what we discuss actually makes sense and raise possible questions that we currently do not have.
